...
int main(int argc, char* argv[])
{
	...
	printf("deleteing first thing\n");
	//PatientInfo newPerson = NULL;
	deleteFromList(&patientsList, &patient);

	printf("printing the list\n");
	printList(patientsList,printPatient);

	printf("deleteing 1 thing\n");
	ListNode *p2 = patientsList;
	p2 = p2->next;

	deleteNode(&patientsList, p2);


	printf("printing the list\n");
	printList(patientsList,printPatient);

	printf("inserting the first\n");
	insertToList(&patientsList, &p2->patient);

	printf("printing the list\n");
	printList(patientsList,printPatient);

	printf("inserting after\n");
	ListNode *p3 = patientsList;
	p2 = patientsList;

	insertAfter(p2->next, &p3->patient);
